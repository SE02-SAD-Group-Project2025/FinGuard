      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-9">
            <Link to="/" className="text-black hover:bg-green-200 px-3 py-2 rounded-md text-sm font-medium">Home</Link>
            ...
            <Link to="/login" className="text-black bg-green-300 hover:bg-green-400 px-4 py-2 rounded-md text-sm font-medium">Login</Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden bg-green-100">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link to="/" onClick={() => setIsOpen(false)} className="block text-black hover:bg-green-200 px-3 py-2 rounded-md text-base font-medium">Home</Link>
              ...
              <Link to="/login" onClick={() => setIsOpen(false)} className="block text-black bg-green-300 hover:bg-green-400 px-3 py-2 rounded-md text-base font-medium">Login</Link>
            </div>
          </div>
        )}
      </div>
