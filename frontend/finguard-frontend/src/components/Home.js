      ...
      <div id="pricing-section" className="bg-gradient-to-br from-emerald-50 to-green-50 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-8 flex-wrap">
            ...
            <div className="w-full max-w-sm p-8 border-2 border-blue-300 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 shadow-xl hover:shadow-2xl transition-all duration-300 relative">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Premium Monthly</h3>
                <div className="text-4xl font-bold text-blue-600 mb-2">LKR 999<span className="text-lg text-gray-600">/month</span></div>
                <p className="text-gray-600">Pay monthly, cancel anytime</p>
              </div>
            ...
            {/* Premium Yearly Plan */}
            <div className="w-full max-w-sm p-8 border-2 border-green-300 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 shadow-xl hover:shadow-2xl transition-all duration-300 relative transform scale-105">
              {/* Best Value badge */}
              ...
              <div className="text-center mb-6 pt-4">
                ...
                <div className="text-4xl font-bold text-green-600 mb-1">LKR 10,000</div>
                <div className="text-sm text-gray-500 line-through mb-2">LKR 11,988 if paid monthly</div>
                <p className="text-gray-600">Save 17% with annual billing</p>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  <span className="mr-3 text-green-500">✅</span> 
                  <span className="text-gray-700">Family management</span>
                </li>
                <li className="flex items-center">
                  <span className="mr-3 text-green-500">✅</span> 
                  <span className="text-gray-700 font-bold">2 months FREE</span>
                </li>
              </ul>
              
              <Link
                to="/subscription/plans"
                className="w-full inline-block bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold px-6 py-4 rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Choose Yearly Plan
              </Link>
              
              <p className="text-center text-xs text-gray-600 mt-3">
                Billed annually • Best value for money
              </p>
            </div>
          </div>
        </div>
